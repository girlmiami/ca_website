...
class PrivateCompanyForm extends StatefulWidget {
  @override
  _PrivateCompanyFormState createState() => _PrivateCompanyFormState();
}

class _PrivateCompanyFormState extends State<PrivateCompanyForm> {
